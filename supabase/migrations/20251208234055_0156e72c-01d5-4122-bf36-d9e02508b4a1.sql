-- Update blog post content with cleaned formatting

UPDATE blog_posts SET content = 'You''ve lived next to them for months, maybe years. You wave politely when you''re both getting mail. But what if your neighbor has exactly what you need?
...
author = 'TheNExT Team'
WHERE slug = 'september-reset-meet-your-neighbors';

UPDATE blog_posts SET content = 'That china set hasn''t seen the light of day in five years. The craft supplies are gathering dust. The books are taking up space you actually need. But throwing them away feels wrong. There''s a better way.
...
author = 'TheNExT Team'
WHERE slug = 'art-of-letting-go-decluttering-guide';

UPDATE blog_posts SET content = 'You finally bought the house. You have the yard, the garage, the space you dreamed about. So why does every weekend feel like a home improvement emergency you''re not qualified to handle?
...
author = 'TheNExT Team'
WHERE slug = 'millennial-homeowner-dilemma-neighborhood-help';

UPDATE blog_posts SET content = 'Your professors can teach you calculus and literary theory. But who''s going to teach you how to cook something other than ramen, fix a flat tire, or negotiate with a landlord? Plot twist: your neighbors already know all this stuff.
...
author = 'TheNExT Team'
WHERE slug = 'college-student-adult-skills-guide';

UPDATE blog_posts SET content = 'That tiny pair of Vans hasn''t fit your daughter in three years, but every time you try to donate them, you remember her chubby toddler feet taking their first confident steps. What if instead of saying goodbye, you could watch them walk into a new adventure?
...
author = 'TheNExT Team'
WHERE slug = 'second-life-of-things-meaningful-giving';

UPDATE blog_posts SET content = 'She offered to help you move for free. He insisted on giving you his extra furniture. They won''t take any money for babysitting your kids. So why do you feel worse instead of better? And why does it feel different when you can give something back?
...
author = 'TheNExT Team'
WHERE slug = 'psychology-of-exchange-trading-vs-charity';

UPDATE blog_posts SET content = 'Amazon wants you to believe that your neighbor can''t provide what you need. Target wants you to think that buying new is the only way to get quality. Big brands have convinced us that community is inconvenient and commerce is connection. They''re lying, and deep down, you know it.
...
author = 'TheNExT Team'
WHERE slug = 'take-power-back-community-over-commerce';